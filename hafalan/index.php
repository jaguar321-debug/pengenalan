            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        include 'koneksi.php';
                        $no = 1;
                        $data = mysqli_query($koneksi, "select * from hafalan");
                        while($d = mysqli_fetch_array($data)){
                            ?>
                        <tr>
                            <th scope="row"><?php echo $no++; ?></th>
                            <td><?php echo $d['nama_juz']; ?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <a href="edit.php?id_juz=<?php echo $d['id_juz']; ?>" class="btn btn-warning">Edit</a>
                                <a href="hapus.php?id_juz=<?php echo $d['id_juz']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Mau Hapus??')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
