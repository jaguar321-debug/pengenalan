                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id_guru=<?php echo $d['id_guru']; ?>" class="btn btn-warning">Edit</a>
                                <a href="hapus.php?id_guru=<?php echo $d['id_guru']; ?>" class="btn btn-danger  " onclick="return confirm('Apakah Yakin Mau Hapus??')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
