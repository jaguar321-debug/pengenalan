                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id_kelas=<?php echo $d['id_kelas']; ?>" class="btn btn-warning">Edit</a>
                                <a href="hapus.php?id_kelas=<?php echo $d['id_kelas']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Mau Hapus??')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
